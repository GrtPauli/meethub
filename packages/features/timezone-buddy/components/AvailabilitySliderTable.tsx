    ...
    <>
      {theme != null && (
        <UpgradeTip
          ...
          // background={theme == "dark" ? "/tips/teams-dark" : "/tips/teams"}
          theme={theme}
          darkBackground="/tips/teams-dark"
          lightBackground="/tips/teams"
          features={[]}
          buttons={
...
export function AvailabilitySliderTable({theme}: any) {
  ...
  if (!flatData.length) return <UpgradeTeamTip theme={theme} />;
