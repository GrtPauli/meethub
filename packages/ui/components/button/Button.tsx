...
export const buttonClasses = cva(
  "whitespace-nowrap inline-flex items-center text-sm font-medium relative rounded-md transition-colors disabled:cursor-not-allowed",
  {
    variants: {
      ...
      color: {
        primary:
          "bg-brand-default capitalize hover:bg-inverted hover:text-inverted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset focus-visible:ring-brand-default text-white disabled:bg-brand-subtle disabled:text-brand-subtle disabled:opacity-40 disabled:hover:bg-brand-subtle disabled:hover:text-brand-default disabled:hover:opacity-40",
        secondary:
      ...
      size: {
        ...
        base: "h-[40px] px-4 py-2.5 ",
        lg: "h-[45px] px-4 py-2.5 ",
      },
      loading: {
        true: "cursor-wait",
      },
