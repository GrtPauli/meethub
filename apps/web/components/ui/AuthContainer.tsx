...
export default function AuthContainer(props: React.PropsWithChildren<Props>) {
  ...
  return (
    <div className="bg-muted flex min-h-screen flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      {props.showLogo && <Logo theme={theme} small inline={false} className="mb-aut mx-auto" />}
      ...
      <div className="mb-auto mt-2 sm:mx-auto sm:w-full sm:max-w-lg">
        <div className="bg-default border-subtl borde mx-2 rounded-md px-5 py-10 shadow-xl sm:px-10">
          {props.heading && (
            <h2 className="text-emphasis mb-3 text-2xl font-black capitalize">{props.heading}</h2>
          )}
          {props.children}
        </div>
